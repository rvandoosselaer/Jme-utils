...
/**
 * An example third person camera implementation using Lemur's {@link InputMapper}. This AppState can be used as a
 * starting point for other camera implementations.
 * The {@link ThirdPersonCameraTest} is a runnable example of this camera.
 *
 * @author remy
 */
